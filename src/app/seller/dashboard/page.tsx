        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold" data-testid="total-products">{stats.totalProducts}</h3>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold" data-testid="total-orders">{stats.totalOrders}</h3>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold" data-testid="pending-orders">{stats.pendingOrders}</h3>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold" data-testid="average-rating">${stats.totalRevenue.toFixed(2)}</h3>
            </div>
            <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center" data-testid="sales-chart">
